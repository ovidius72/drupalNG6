System.config({
  ...
  map: {
    ...
    "angular-mocks": "npm:angular-mocks@1.4.9",
    ...
    "npm:cross-spawn@2.1.5": {
      "cross-spawn-async": "npm:cross-spawn-async@2.1.8",
      "process": "github:jspm/nodelibs-process@0.1.2",
    ...
    "npm:lodash.template@3.6.2": {
      ...
      "lodash._reinterpolate": "npm:lodash._reinterpolate@3.0.0",
      "lodash.escape": "npm:lodash.escape@3.1.2",
    ...
    "npm:node-sass@3.4.2": {
      ...
      "mkdirp": "npm:mkdirp@0.5.1",
      "nan": "npm:nan@2.2.0",
      "node-gyp": "npm:node-gyp@3.2.1",
      "npmconf": "npm:npmconf@2.1.2",
      "os": "github:jspm/nodelibs-os@0.1.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "request": "npm:request@2.69.0",
      "sass-graph": "npm:sass-graph@2.1.0",
      "systemjs-json": "github:systemjs/plugin-json@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    "npm:node-uuid@1.4.7": {
